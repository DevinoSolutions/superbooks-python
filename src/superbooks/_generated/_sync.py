...
from .._namespace import SyncNamespace
...
class Transactions(SyncNamespace):
...
class Categories(SyncNamespace):
    ...
    def list(
        ...
        small.
        """
        return self._call("categories_list", {})
...
class BankAccounts(SyncNamespace):
...
class Team(SyncNamespace):
    ...
    def get(
        ...
        """
        return self._call("team_get", {})

class Search(SyncNamespace):
...
class Reports(SyncNamespace):
    ...
    def runway(
        ...
        `reports_burn_rate`.
        """
        return self._call("reports_runway", {})
    ...
    def balance(
        ...
        instead.
        """
        return self._call("reports_balance", {})
    ...
    def recurring_expenses(
        ...
        """
        return self._call("reports_recurring_expenses", {})
